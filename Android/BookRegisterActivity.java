...
public class BookRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MyLog.d(TAG, "infoItem " + bookinfoItem.toString());
        MyLog.d(TAG, "infoItem " + bookinfoItem);

        setToolbar();

        currentLength = (TextView) findViewById(R.id.text_cnt);
        nameEdit = (EditText) findViewById(R.id.edit_name);
        publisherEdit = (EditText) findViewById(R.id.edit_publisher);
        ...
        ImageView imageRegister = (ImageView) findViewById(R.id.book_image_register);
    ...
    private void setToolbar() {
        ...
        if (actionBar != null) {
            ...
            actionBar.setTitle(R.string.book_register);
        }
    }
    ...
    public void onClick(View v) {
        ...
        bookinfoItem.name = nameEdit.getText().toString();
        bookinfoItem.publisher = publisherEdit.getText().toString();
        bookinfoItem.description = descriptionEdit.getText().toString();
        MyLog.d(TAG, "onClick imageItem " + bookinfoItem);
    ...
    private void insertBookInfo() {
        ...
        Call<String> call = remoteService.insertBookInfo(bookinfoItem);
