...
router.post('/phone', function(req, res) {
  ...
  var sql_insert = "insert into book_member (phone) values(?);";
...
router.post('/info', function(req, res) {
  ...
  var sql_insert = "insert into book_member (phone, name, sextype, birthday) values(?, ?, ?, ?);";
  var sql_update = "update book_member set name = ?, sextype = ?, birthday = ? where phone = ?; ";
  var sql_select = "select seq from book_member where phone = ?; ";
...
router.post('/icon_upload', function (req, res) {
  ...
  form.parse(req, function(err, fields, files) {
    var sql_update = "update book_member set member_icon_filename = ? where seq = ?;";
